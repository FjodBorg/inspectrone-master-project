...
//   {
//     timer_ = nodeHandle_.createTimer(ros::Duration(0.1), &PlyPublisher::timerCallback, this);
//   }
//   else
//   {
...
//     ROS_INFO("found .ply at %s", filePath.c_str());
//     // Load .ply file.
...
//     ROS_INFO("found .vtk at %s", filePath.c_str());
//     // Load .vtk file.
...
{
  ros::init(argc, argv, "simple_ply_publisher");
  ros::NodeHandle nh("~");
